...
import { ExternalLink, Search, Star, GitFork, Loader2, ArrowLeft } from "lucide-react";
...
/** Map GitHub language to a category */
function inferCategory(language: string | null, topics: string[]): string {
...
export default function ProjectsList({ curatedProjects, curatedCategories }: Readonly<Props>) {
  ...
  const allProjects = [...curatedWithSource, ...githubProjects];
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-6 sm:px-12 lg:px-20 py-20">
      ...
      {/* Loading indicator */}
      {loading && (
        <div className="flex items-center gap-2 text-[13px] text-[#999999] mb-4">
